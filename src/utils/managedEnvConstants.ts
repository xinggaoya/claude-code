 ...
 * OPENAI_MODEL, OPENAI_DEFAULT_*_MODEL, OPENAI_SMALL_FAST_MODEL,
 * OPENAI_REASONING_EFFORT, OPENAI_USE_RESPONSES, OPENAI_USE_CHAT_COMPLETIONS)
 * which are all provider-managed to keep routing
 * config isolated from Anthropic settings.
 */
